...
NOTION_BUY_TYPE = 'Buy'
NOTION_YOUTUBE_TYPE = 'Youtube'
NOTION_PODCAST_TYPE = 'Podcast'
NOTION_READ_TYPE = 'Read'
NOTION_EXAMINE_TYPE = 'Examine'
NOTION_KEEP_TYPE = 'Keep'
NOTION_EMPTY_TYPE = 'Empty'
NOTION_TYPES = [NOTION_CINEMA_TYPE, NOTION_LINK_TYPE, NOTION_PODCAST_TYPE, NOTION_BUY_TYPE]
